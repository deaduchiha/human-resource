  ...
  .then(({ foods }) => {
    $(document).ready(function () {
      $(document).on("click", "#openBtn", function () {
        ...
        // title
        $(".popup-food-title").text(food.title);
        // images slider
        const imageSwiperWrapper = $(".imagesSwiper .swiper-wrapper");
        ...
        // description
        $(".popup-description-holder p").text(food.details);
        $(".popup-description-holder span").text(food.price);
        $("#popup").fadeIn();
      });
